          ...
          <div class="carousel-item active" style="background-image: url(img/slide/slide-4.jpg)">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInUp">Welcome to 
                    <span>Nakuru City Board</span>    
                    {{-- Did not work --}}
                    {{-- <span class="typed" data-typed-items="Nakuru Municipal Board, Nakuru City Board">
                        </span> --}}
                </h2>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <form action="" method="post">
              <input type="email" name="email" placeholder="client@yondermail.com"><input type="submit" value="Subscribe">
            </form>
          </div>
        </div>
      </div>
