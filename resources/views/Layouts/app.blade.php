...
<body>
  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope d-flex align-items-center"><a href="{{asset('mailto:contact@example.com')}}">contact@example.com</a></i>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
        <h1><a href="/">Nakuru City Board</a></h1>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              Watalii Road <br>
              P.O. Box, 123456-20100 NAKURU<br>
              KENYA <br><br>
              <strong>Phone:</strong> +254712345678<br>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>NakuruCityBoard</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
